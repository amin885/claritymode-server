...
const youtubeScriptProducerRoutes = require('./src/routes/youtubeScriptProducer')
...
app.use('/v2/preferences', preferenceRoutes)
app.use('/v2/product-skills/youtube-script-producer', youtubeScriptProducerRoutes)
